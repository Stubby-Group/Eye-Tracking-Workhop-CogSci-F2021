...
Fixations <- read_csv("C:/Users/cecil/Desktop/r sfuff idk/Eye-Tracking-Workhop-CogSci-F2021/data/Fixations_final.csv", guess_max = Inf)
Saccades <- read_csv("C:/Users/cecil/Desktop/r sfuff idk/Eye-Tracking-Workhop-CogSci-F2021/data/Saccades_final.csv")
```
...
vf_Saccades <- subset(Saccades,Task == "Visual foraging")
se_Saccades <- subset(Saccades,Task == "Social engagement")

plot(density(vf_Saccades$Amplitude))
plot(density(se_Saccades$Amplitude))
