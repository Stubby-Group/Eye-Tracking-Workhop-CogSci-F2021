...
foraging_fixations <- read_csv("/Users/manon/Desktop/Uni og Selvstudie/4. Semester/Eye Tracking Workshop/Eye-Tracking-Workhop-CogSci-F2021/data/foraging_fixations.csv")
soceng_fixations <- read_csv("/Users/manon/Desktop/Uni og Selvstudie/4. Semester/Eye Tracking Workshop/Eye-Tracking-Workhop-CogSci-F2021/data/soceng_fixations.csv")

## Load saccades data for both experiments
foraging_saccades <- read_csv("/Users/manon/Desktop/Uni og Selvstudie/4. Semester/Eye Tracking Workshop/Eye-Tracking-Workhop-CogSci-F2021/data/foraging_saccades.csv")
soceng_saccades <- read_csv("/Users/manon/Desktop/Uni og Selvstudie/4. Semester/Eye Tracking Workshop/Eye-Tracking-Workhop-CogSci-F2021/data/soceng_saccades.csv")
...
```{r}
# Now there are still coordinates outside of the screen. We can delete those...
...
img <- jpeg::readJPEG('/Users/manon/Desktop/Uni og Selvstudie/4. Semester/Eye Tracking Workshop/Eye-Tracking-Workhop-CogSci-F2021/data/stimuli_Foraging/space_capsules.jpg')  
